...
void setup() {
  ...
  tft.pushImage(106,0,214,170,gunnar);
...
void loop() {
 ...
 sprite.drawString("Gunnar",75,16);
 sprite.drawString("Storeboe",75,46);
 ...
 sprite.drawString("WORK",40,134,2);
 sprite.drawString("PLAY",106,134,2);
 sprite.setTextFont(0);
 sprite.drawString("Sail fast, live slow!",80,160);
